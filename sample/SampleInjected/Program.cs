...
namespace SampleInjected
{
	...
	internal unsafe static class Program
	{
		...
		static extern unsafe bool VirtualProtect(IntPtr handle, int size, uint newProtect, uint* oldProtect);
		...
		[STAThread]
		public unsafe static int Bootstrap(IntPtr argument, int size)
		{
		...
		static unsafe BOOL WriteFile_hook(IntPtr hFile, byte* lpBuffer, int nNumberOfBytesToWrite, int* lpNumberOfBytesWritten, IntPtr lpOverlapped)
		{
		...
		private static unsafe bool HookImport(string moduleName, string functionName, nint hookFunction, nint* originalFunction)
		{
