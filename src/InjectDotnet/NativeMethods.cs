...
internal class NativeMethods
{
	...
	[DllImport(KERNEL32, SetLastError = true)]
	public static extern IntPtr VirtualAllocEx(SafeProcessHandle hProcess,
	...
	[DllImport(KERNEL32, SetLastError = true)]
	public static unsafe extern bool WriteProcessMemory(SafeProcessHandle hProcess,
		IntPtr lpBaseAddress, byte* buffer, int nSize, ref int lpNumberOfBytesWritten);
